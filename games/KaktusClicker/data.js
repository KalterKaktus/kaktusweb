...
export const achievements = [
  ...
  { id: "first-frenzy", name: "Goldener Lauf", goal: "Löse den Goldlauf einmal aus.", test: (state) => state.events.frenzies >= 1 },
  ...
  { id: "frenzy-25", name: "Dauergold", goal: "Löse den Goldlauf 25 Mal aus.", test: (state) => state.events.frenzies >= 25 },
...
export const changelogEntries = [
  ...
  },
  {
    ...
    items: [
      ...
      "Der Goldkaktus löst jetzt zusätzlich den Goldlauf aus — fängst du einen während eines laufenden Goldlaufs, startet dieser komplett neu.",
      "Der Rubinkaktus gibt statt 2 Stunden jetzt 1 Stunde Produktion. Er war schlicht zu stark und hat alles andere erdrückt.",
      "„Abzeichen“ heißen jetzt überall „Erfolge“ — dass der Multiplikator von dort kommt, war vorher nicht klar.",
      "10 neue Erfolge, Produktion läuft jetzt auch im Hintergrund-Tab korrekt weiter.",
    ],
    ru: {
      ...
      items: [
        ...
        "Золотой кактус теперь дополнительно запускает Золотой бег — если поймать его во время активного бега, тот начинается заново.",
        "Рубиновый кактус даёт 1 час производства вместо 2. Он был просто слишком силён и подавлял всё остальное.",
        "«Значки» теперь везде называются «Достижения» — раньше было неочевидно, что множитель идёт оттуда.",
        "10 новых достижений, производство теперь корректно идёт и в фоновой вкладке.",
      ],
    },
  },
  {
